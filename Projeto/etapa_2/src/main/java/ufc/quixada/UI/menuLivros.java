            ...
            do {
                try {
                    ...
                    switch(opcao) {
                        ...
                        case '4':
                            titulo = JOptionPane.showInputDialog("Digite o titulo do livro que deseja atualizar");
                            livro = baseLivros.findFirstByTitulo(titulo);
                            if (livro != null) {
                                obterLivros(livro);
                                baseLivros.save(livro);
                            } else {
                        ...
                        case '8':
                            titulo = JOptionPane.showInputDialog("Digite o titulo do livro que deseja deletar");
                            livro = baseLivros.findByTitulo(titulo).get(0);
                            if(livro != null) {
                                baseLivros.deleteById(livro.getIdLivro());
                            } else {
                                JOptionPane.showMessageDialog(null, "Livro não encontrado");
                            }
                            break;
